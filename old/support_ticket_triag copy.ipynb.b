 ...
 "cells": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "a5720571",
    "outputId": "a20e5d75-404f-4f52-ee49-ded9db9ce48f"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Dependency import sanity check passed.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "dcbf7486",
    "outputId": "778e52a5-08f3-4c69-f563-dd9a92563e5c"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "a70b364a",
    "outputId": "1391bfc6-9957-4263-9363-ccea049a0d50"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "73bdd1b4",
    "outputId": "b022f38e-680d-4962-cdd9-8146d4b8d4d0"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "✓ Data loaded successfully from GitHub: https://raw.githubusercontent.com/vjfrosty/Sofuni_agents_support_ticket_triage_submission/main/project_data.json\n",
      "Settings loaded:\n",
      "  embedding_model      = text-embedding-3-small\n",
      "  retriever_top_k      = 4\n",
      "  msg_trim_max_tokens  = 1800\n",
      "  default_tone         = professional_empathetic\n",
      "\n",
      "KB articles     : 17\n",
      "Accounts        : 9\n",
      "Routing rules   : 25\n",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "5dd17b76",
    "outputId": "b38e84e6-0483-4ebe-d927-3722de71b0d0"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Building FAISS vector store from KB articles...\n",
      "Vector store ready: 18 chunks from 17 articles.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "843fdd4e",
    "outputId": "77910264-eea7-40e2-9391-335903ba32c5"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Account contexts loaded : 9\n",
      "Routing rules loaded    : 25\n",
      "Test cases loaded       : 7\n",
      "Memory defaults loaded  : 20 namespaces\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "f8cc6c37",
    "outputId": "b5e4de0a-5fb5-4ecb-d0a9-c7885975fa3d"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Memory defaults seeded: 62 entries across 20 namespaces.\n",
      "Long-term memory DB ready.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "98fb06b2",
    "outputId": "44b5fcf5-63a8-42b2-97b8-435c36e45d00"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "prepare_messages ready (max_tokens=1800).\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "69eb1fa3",
    "outputId": "5a41b1c4-f64b-4f70-cfc2-84ee8b88f0a3"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "build_prompt_messages ready (injects trimmed history; max_tokens=1800).\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "d7f1fe45",
    "outputId": "635309db-7bb3-4fef-998b-3796b8dddd10"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      "log_step() ready.\n",
      "Guardrails ready: redact_pii, check_forbidden_topics, apply_guardrails.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "20729020",
    "outputId": "ec49734d-c953-4318-a89d-bc7cc31e1b30"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "TicketState, TriageOutput, ResolutionPlan defined.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "18fcbe85",
    "outputId": "e60ba96a-6b86-4af9-d9e0-e28503f21d21"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "LLMs ready: base_llm (gpt-4o-mini), triage_llm, plan_llm. (routing_llm → Cell 28)\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "1c0549d7",
    "outputId": "7fb878d0-9e76-4f37-c7b0-5ab661872cf5"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Prompts defined: TRIAGE_SYSTEM, RETRIEVAL_SYSTEM, RESOLUTION_SYSTEM, DRAFTING_SYSTEM, REVISION_SYSTEM.\n",
      "TEAM_DISPLAY_NAMES: ['billing_support', 'technical_support', 'retention_team', 'human_specialist', 'legal_team']\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "f2acf2ce",
    "outputId": "4c9e14de-1a32-48a9-a9c6-a2a25b0bf5bd"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "  - priority_score\n",
      "  - route_policy_lookup\n",
      "routing_llm ready (API-forced bind_tools on route_policy_lookup).\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "fbe1a47b",
    "outputId": "fb28eb76-8fed-4d41-c0aa-d5937481e3e3"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "with_retry() and PRIORITY_RANK ready.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "d4005bf4",
    "outputId": "8f95b825-fe8f-4717-cf72-c4ac48bf515d"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "All 10 node functions + after_draft_route conditional edge defined.\n"
     ]
    }
   ],
   "source": [
   ...
   "outputs": [
    {
     ...
     "output_type": "stream",
     "text": [
      "Hotfix applied: retrieval_node updated. Re-run Cell 35 to rebuild graph.\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "69bdcf99",
    "outputId": "5acd1cf9-a1f8-4177-9a66-f1318fb40dee"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      ...
      "Nodes: ['load_memory', 'triage', 'clarify', 'retrieve', 'resolve', 'draft', 'review', 'revise', 'finalize', 'manual_escalation']\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "506f3804",
    "outputId": "10864db0-26a7-4687-bc4f-6d361a2ccb8a"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "Core functions ready: execute_workflow, resume_workflow, get_interrupt_payload\n",
      "Helpers: print_summary, print_interrupt, print_user_memory, print_agent_trace\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "ef75ace1",
    "outputId": "a870099f-26e2-4e34-e789-694fb813c411"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "dbc1ddbd",
    "outputId": "29be7d1f-9230-4306-8e5f-81ad7ef665b7"
   },
   "outputs": [
    {
     "name": "stdout",
     "output_type": "stream",
     "text": [
      "run_test_case ready.  📊 Metrics stored in SQLite under metrics:workflow per test_id\n"
     ]
    }
   ],
   "source": [
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "f82cf19d",
    "outputId": "24c0b041-3dbe-42b0-a73f-1a17aa873384"
   },
   "outputs": [
    {
     "name": "stdout",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "16be37d9",
    "outputId": "7325f5e9-8723-4feb-a6ba-369e433fca6c"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      "\n",
      "=================================================================\n",
      "  TEST : test_01_duplicate_billing\n",
      "=================================================================\n",
      "  INPUT    : Account acct_1001 here. I was charged twice on this month's bill and nobody answered my last email. What is happening?\n",
      "  EXPECTED : category=billing  priority=high\n",
      "  EXPECTED : route=billing_support  escalation=True\n",
      "  DECISION : approve\n",
      "  NOTES    : Matches refund-pending account context and duplicate-charge KB guidance. HITL: approve path.\n",
      "\n",
      ...
      ">> STEP 2: resume_workflow() — decision: approve\n",
      "  [review] HITL interrupt — waiting for human decision...\n",
      "  [review] Decision: APPROVE\n",
      "  [finalize] Memory written back for acct_1001.\n",
      "   [💰 tokens] calls=4  in=3,578  out=243  cost=$0.00068\n",
      "\n",
      "  ── Agent trace ──────────────────────────────\n",
      "  … → finalize_node [APPROVED]  thread=25ea2233…\n",
      "  category=billing  priority=high\n",
      "  route=billing_support  escalation=True\n",
      "  ────────────────────────────────────────────\n",
      "\n",
      "\n",
      "==============================================================\n",
      "  RESULT: test_01_duplicate_billing\n",
      "==============================================================\n",
      "  status                    : approved\n",
      "  category                  : billing\n",
      ...
      "  FINAL REPLY:\n",
      "  --------------------------------------------------\n",
      "  I completely understand your frustration and sincerely apologise for the inconvenience. It appears that you have been charged twice this month, and there is already a refund review open for a previous duplicate charge on your account.\n",
      "  \n",
      "  I will escalate this matter to our Billing Support team, who will review your payment activity and check the status of the pending refund. They will ensure that your concerns are addressed and provide you with clear next steps.\n",
      "  \n",
      "  You can expect to hear back from them within 1 business day. Thank you for your patience as we work to resolve this issue.\n",
      "\n",
      "\n",
      "  Long-term memory — acct_1001:\n",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "25080f41",
    "outputId": "199105ac-1e14-4e67-f75c-1a703a9fbcee"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      "\n",
      "=================================================================\n",
      "  TEST : test_02_business_outage\n",
      "=================================================================\n",
      "  INPUT    : This is acct_1002. Our office internet has been down since this morning, multiple people cannot work, and we need urgent help.\n",
      "  EXPECTED : category=technical  priority=critical\n",
      "  EXPECTED : route=technical_support  escalation=True\n",
      "  DECISION : escalate_manually\n",
      "  NOTES    : Business-tier outage with known outage context triggers critical handling. HITL: manual escalation path.\n",
      "\n",
      ">> STEP 1: execute_workflow()\n",
      ...
      "  [triage] category=technical  priority=critical  sentiment=frustrated  escalation=True  account_id=acct_1002\n",
      "  [route] → retrieve\n",
      "  [retrieve] kb_hits=4  account_found=True  escalation=True  priority_signal=critical  kb_category=technical\n",
      "  [resolve] route_policy_lookup called with args={'category': 'technical', 'priority': 'critical'}  → route_to_team=technical_support\n",
      "  [resolve] route=technical_support  action=declare_incident_handling and fast track business \n",
      "  [draft] tone=professional_empathetic  length=586 chars\n",
      "  [route] draft → review  (reason: requires_escalation=True)\n",
      "  [review] HITL interrupt — waiting for human decision...\n",
      "   thread_id = 778be5cd-3534-43e3-861f-8033f5d1cc64\n",
      "   [NOTE] Interrupt detected via graph.get_state() (LangGraph 0.2.x fallback)\n",
      "   Interrupted at review_node. Draft: I completely understand your frustration and sincerely apologise for the inconve...\n",
      ...
      "   [💰 tokens] calls=4  in=3,493  out=242  cost=$0.00067\n",
      "\n",
      "  ── Agent trace ──────────────────────────────\n",
      "  … → manual_escalation_node [ESCALATED]  thread=778be5cd…\n",
      "  category=technical  priority=critical\n",
      "  route=technical_support  escalation=True\n",
      "  ────────────────────────────────────────────\n",
      "\n",
      "\n",
      "==============================================================\n",
      "  RESULT: test_02_business_outage\n",
      "==============================================================\n",
      "  status                    : manual_escalation\n",
      "  category                  : technical\n",
      ...
      "  recommended_action        : declare_incident_handling and fast track business impact\n",
      "  human_approved            : False\n",
      "  errors                    : []\n",
      "\n",
      "  FINAL REPLY:\n",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "3af5f5fa",
    "outputId": "103fae51-e746-4c57-8741-5da65db060d6"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      "\n",
      "=================================================================\n",
      "  TEST : test_03_login_access\n",
      "=================================================================\n",
      "  INPUT    : I'm on acct_1008 and I still cannot log in after resetting my password yesterday. The code step is also failing.\n",
      "  EXPECTED : category=account_access  priority=medium\n",
      "  EXPECTED : route=account_access_support  escalation=False\n",
      "  DECISION : approve\n",
      "  NOTES    : Grounded in login-reset and MFA lockout KB articles. HITL: approve path.\n",
      "\n",
      ">> STEP 1: execute_workflow()\n",
      ...
      "  [draft] tone=empathetic  length=836 chars\n",
      ...
      "   thread_id = d5d3b874-6783-4f24-9b9c-1c7a8decae31\n",
      "   No interrupt — workflow completed without HITL (auto-finalize or clarify).\n",
      "   [💰 tokens] calls=4  in=3,644  out=293  cost=$0.00072\n",
      "\n",
      "  ── Agent trace ──────────────────────────────\n",
      "  … → finalize_node [APPROVED]  thread=d5d3b874…\n",
      "  category=account_access  priority=medium\n",
      "  route=account_access_support  escalation=False\n",
      "  ────────────────────────────────────────────\n",
      "\n",
      "\n",
      "==============================================================\n",
      "  RESULT: test_03_login_access\n",
      "==============================================================\n",
      "  status                    : approved\n",
      ...
      "  sentiment                 : frustrated\n",
      "  requires_escalation       : False\n",
      "  route_to_team             : account_access_support\n",
      "  recommended_action        : verify_identity_and_restore_safe_access\n",
      "  human_approved            : True\n",
      "  errors                    : []\n",
      "\n",
      "  FINAL REPLY:\n",
      ...
      "  \n",
      "  It appears that after resetting your password, you are still unable to log in, and the code step is failing. This can happen if the new password was not accepted or if there are issues with the verification process.\n",
      "  \n",
      "  To assist you further, I will escalate your case to our support team. They will verify your identity and work on restoring your access as quickly as possible. \n",
      "  \n",
      "  You can expect to hear back from them within 2 business days. In the meantime, please ensure that you are using the most recent password you set and that you are entering it correctly. If you have any additional details about the error messages you are receiving, please share them, as they can help expedite the resolution.\n",
      "\n",
      "\n",
      "  Long-term memory — acct_1008:\n",
      ...
      "  [INFO] Test 3 path: auto-finalize\n",
  ...
  },
  {
   ...
   "metadata": {
    ...
    "id": "e4065583",
    "outputId": "71d1af64-aa68-4c1c-c6df-5fb0d77b860c"
   },
   "outputs": [
    {
     "name": "stdout",
     ...
     "text": [
      "\n",
      "=================================================================\n",
      "  TEST : test_04_cancellation_threat\n",
      "=================================================================\n",
      "  INPUT    : acct_1004. If this is not fixed today, cancel everything. I am done with this service and I want someone senior to look at it.\n",
      "  EXPECTED : category=cancellation  priority=high\n",
      "  EXPECTED : route=retention_team  escalation=True\n",
      "  DECISION : revise: strengthen the empathetic opening and make the next steps more\n",
      "  NOTES    : Retention-risk with existing escalation history in long-term memory. HITL: revision path. Memory write-back should record tone=empathetic.\n",
      "\n",
      ">> STEP 1: execute_workflow()\n",
